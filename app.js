...
function getIconUrl(iconCode){
    return `ìcons/${ICON_MAP.get(iconCode)}.svg`
}
...
function renderDailyWeather(daily){
    ...
    daily.forEach(day =>{
        ...
        setValue("data", DAY_FORMATTER.format(day.timestamp),{parent: element})
...
function renderHourlyWeather(hourly){
    ...
    hourly.forEach(day =>{
        ...
        setValue("fl-temp", hour.lowFeelsLike, {parent: element})
